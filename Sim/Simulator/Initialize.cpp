...
/*
    ...
    //ILint Mode = il2GetInteger(IL_TYPE_MODE);
    //qDebug() << "Resil Version: " << Mode;
*/
...
/*
    ...
    SpaceStationTexture->setSource (QUrl(QStringLiteral("file:Objects/moon.jpg")));
    ...
    SpaceStationAnim->setDuration (2000000);
    ...
    SpaceStationAnim->setPropertyName ("rotationZ");
    ...
    MoonTexture->setSource (QUrl(QStringLiteral("file:Objects/Moon.webp")));
...
*/
    ...
    // Object Transforms
    //Qt3DCore::QTransform *ObjectTransforms = new Qt3DCore::QTransform();
    //ObjectTransforms->setTranslation(QVector3D(-100.0f, 0.0f, -100.0f));
    //ObjectTransforms->setRotationX(0.0f);
    //ObjectTransforms->setScale (1.0f);
    //SceneLoaderEntity->addComponent(ObjectTransforms);
...
/*
    QUrl SourceFileName;
        ...
        //ShipDiffuse->setSpecular (QColor::fromRgbF(0.2f, 0.2f, 0.2f, 1.0f));
